...
public:
	...
	JEdit(void);
	JEdit(SHORT x, SHORT y, SHORT width, SHORT height, const std::string& text = std::string(), 
		JWindow* parent = jApp->Root(), EchoMode mode = JEdit::EM_NORMAL, VALIDATOR validator = DefaultValidator);
